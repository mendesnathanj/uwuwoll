...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/crunchyroll.jsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./frontend/actions/anime_actions.js":
/*!*******************************************!*\
  !*** ./frontend/actions/anime_actions.js ***!
  \*******************************************/
/*! exports provided: RECEIVE_ALL_ANIME, RECEIVE_ANIME, fetchAllAnime, fetchAnime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_ALL_ANIME", function() { return RECEIVE_ALL_ANIME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_ANIME", function() { return RECEIVE_ANIME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchAllAnime", function() { return fetchAllAnime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchAnime", function() { return fetchAnime; });
/* harmony import */ var _utils_anime_api_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/anime_api_utils */ "./frontend/utils/anime_api_utils.js");

var RECEIVE_ALL_ANIME = 'RECEIVE_ALL_ANIME';
var RECEIVE_ANIME = 'RECEIVE_ANIME';

var receiveAllAnime = function receiveAllAnime(payload) {
  return {
...
var receiveAnime = function receiveAnime(payload) {
  return {
    type: RECEIVE_ANIME,
    payload: payload
  };
...
var fetchAllAnime = function fetchAllAnime() {
  return function (dispatch) {
    return _utils_anime_api_utils__WEBPACK_IMPORTED_MODULE_0__["fetchAllAnime"]().then(function (payload) {
      return dispatch(receiveAllAnime(payload));
    });
  };
};
var fetchAnime = function fetchAnime(slug) {
  return function (dispatch) {
    return _utils_anime_api_utils__WEBPACK_IMPORTED_MODULE_0__["fetchAnime"](slug).then(function (payload) {
      return dispatch(receiveAnime(payload));
    });
  };
};
...
/*!*********************************************!*\
  !*** ./frontend/actions/episode_actions.js ***!
  \*********************************************/
/*! exports provided: RECEIVE_EPISODE, fetchEpisode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_EPISODE", function() { return RECEIVE_EPISODE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchEpisode", function() { return fetchEpisode; });
/* harmony import */ var _utils_episodes_api_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/episodes_api_util */ "./frontend/utils/episodes_api_util.js");

var RECEIVE_EPISODE = 'RECEIVE_EPISODE';

var receiveEpisode = function receiveEpisode(payload) {
  return {
...
var fetchEpisode = function fetchEpisode(episodeId) {
  return function (dispatch) {
    return _utils_episodes_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchEpisode"](episodeId).then(function (payload) {
      return dispatch(receiveEpisode(payload));
    });
  };
};
...
/*!*******************************************!*\
  !*** ./frontend/actions/lists_actions.js ***!
  \*******************************************/
/*! exports provided: RECEIVE_LIST, fetchList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_lists_api_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/lists_api_utils */ "./frontend/utils/lists_api_utils.js");
...
var fetchList = function fetchList() {
  return function (dispatch) {
    return _utils_lists_api_utils__WEBPACK_IMPORTED_MODULE_0__["fetchList"]().then(function (payload) {
      return dispatch(receiveList(payload));
    });
  };
};
...
/*!*********************************************!*\
  !*** ./frontend/actions/session_actions.js ***!
  \*********************************************/
/*! exports provided: RECEIVE_CURRENT_USER, LOGOUT_CURRENT_USER, RECEIVE_LOGIN_ERRORS, login, logout, signup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var login = function login(user) {
  return function (dispatch) {
    return _utils_session_api_utils__WEBPACK_IMPORTED_MODULE_0__["login"](user).then(function (user) {
...
var logout = function logout() {
  return function (dispatch) {
    return _utils_session_api_utils__WEBPACK_IMPORTED_MODULE_0__["logout"]().then(function () {
...
var signup = function signup(user) {
  return function (dispatch) {
    return _utils_session_api_utils__WEBPACK_IMPORTED_MODULE_0__["signup"](user).then(function (user) {
      return dispatch(receiveCurrentUser(user));
    }, function (errs) {
      return dispatch(receiveErrors(errs.responseJSON));
    });
...
/***/ "./frontend/components/anime/anime_index.jsx":
/*!***************************************************!*\
  !*** ./frontend/components/anime/anime_index.jsx ***!
  \***************************************************/
...
/* harmony import */ var _anime_index_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./anime_index_item */ "./frontend/components/anime/anime_index_item.jsx");
...
var AnimeIndex = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(AnimeIndex, [{
    ...
    value: function render() {
      ...
      }, "Anime")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "anime-container"
      }, animeItems));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (AnimeIndex);

/***/ }),

/***/ "./frontend/components/anime/anime_index2.jsx":
/*!****************************************************!*\
  !*** ./frontend/components/anime/anime_index2.jsx ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _anime_index_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./anime_index_item */ "./frontend/components/anime/anime_index_item.jsx");
...
var AnimeIndex = function AnimeIndex() {
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["useDispatch"])();
  var anime = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["useSelector"])(function (state) {
    return Object.values(state.entities.anime);
  }, react_redux__WEBPACK_IMPORTED_MODULE_1__["shallowEqual"]);
  var savedAnime = new Set(Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["useSelector"])(function (state) {
    return Object.values(state.entities.savedAnime).map(function (saved) {
      return saved.animeId;
    });
  }));
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    return dispatch(Object(_actions_anime_actions__WEBPACK_IMPORTED_MODULE_2__["fetchAllAnime"])());
  }, []);
  var animeItems = anime.map(function (anime) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_anime_index_item__WEBPACK_IMPORTED_MODULE_4__["default"], {
      createSavedAnime: _actions_saved_anime_actions__WEBPACK_IMPORTED_MODULE_3__["createSavedAnime"],
      deleteSavedAnime: _actions_saved_anime_actions__WEBPACK_IMPORTED_MODULE_3__["deleteSavedAnime"],
      key: anime.id,
      anime: anime,
...
/***/ "./frontend/components/anime/anime_index_container.js":
/*!************************************************************!*\
  !*** ./frontend/components/anime/anime_index_container.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mstp, mdtp)(_anime_index__WEBPACK_IMPORTED_MODULE_1__["default"]));

/***/ }),

/***/ "./frontend/components/anime/anime_index_item.jsx":
/*!********************************************************!*\
  !*** ./frontend/components/anime/anime_index_item.jsx ***!
  \********************************************************/
/*! exports provided: default */
...
var AnimeIndexItem = /*#__PURE__*/function (_React$Component) {
  ...
  return AnimeIndexItem;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component);

/* harmony default export */ __webpack_exports__["default"] = (AnimeIndexItem);

/***/ }),

/***/ "./frontend/components/anime/anime_page.jsx":
/*!**************************************************!*\
  !*** ./frontend/components/anime/anime_page.jsx ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _season_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./season_item */ "./frontend/components/anime/season_item.jsx");
/* harmony import */ var _episode_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./episode_list */ "./frontend/components/anime/episode_list.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(AnimePage, [{
    ...
    value: function render() {
      ...
      if (this.props.seasons.length > 0) {
        ...
        seasonItems = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_episode_list__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "anime-page-description"
      }, "Number of episodes: ", this.props.anime.episodeCount), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "anime-page-description"
      }, this.props.anime.description)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "right-col-anime-page"
      }, seasonItems));
    }
  }]);
...
/***/ "./frontend/components/anime/anime_page_container.js":
/*!***********************************************************!*\
  !*** ./frontend/components/anime/anime_page_container.js ***!
  \***********************************************************/
/*! exports provided: default */
...
/***/ "./frontend/components/anime/episode_list.jsx":
/*!****************************************************!*\
  !*** ./frontend/components/anime/episode_list.jsx ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _episodes_episode_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../episodes/episode_item */ "./frontend/components/episodes/episode_item.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var EpisodeList = /*#__PURE__*/function (_React$Component) {
  _inherits(EpisodeList, _React$Component);

  function EpisodeList(props) {
    _classCallCheck(this, EpisodeList);

    return _possibleConstructorReturn(this, _getPrototypeOf(EpisodeList).call(this, props));
  }
  ...
  _createClass(EpisodeList, [{
    ...
    value: function render() {
      ...
      var episodes = this.props.episodes.map(function (episode) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_episodes_episode_item__WEBPACK_IMPORTED_MODULE_1__["default"], {
          key: episode.id,
...
/***/ "./frontend/components/anime/hover_item.jsx":
/*!**************************************************!*\
  !*** ./frontend/components/anime/hover_item.jsx ***!
  \**************************************************/
/*! exports provided: default */
...
var HoverItem = /*#__PURE__*/function (_React$Component) {
  _inherits(HoverItem, _React$Component);
  ...
  function HoverItem(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HoverItem).call(this, props));
    _this.state = {
      hoverLeft: false
    };
    return _this;
...
/***/ "./frontend/components/anime/season_item.jsx":
/*!***************************************************!*\
  !*** ./frontend/components/anime/season_item.jsx ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _episode_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./episode_list */ "./frontend/components/anime/episode_list.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var SeasonItem = /*#__PURE__*/function (_React$Component) {
  _inherits(SeasonItem, _React$Component);

  function SeasonItem(props) {
    var _this;

    _classCallCheck(this, SeasonItem);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SeasonItem).call(this, props));
    _this.state = {
      expanded: _this.props.expanded
    };
    _this.toggleEpisodeList = _this.toggleEpisodeList.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(SeasonItem, [{
    key: "toggleEpisodeList",
    value: function toggleEpisodeList() {
      this.setState({
    ...
    value: function render() {
      ...
      var episodes = this.props.episodes.filter(function (ep) {
        return ep.seasonId === _this2.props.season.id;
      });
      var hideEpisodes = this.state.expanded ? '' : 'hide-episodes';
      var rotateCaret = this.state.expanded ? '' : 'fa-rotate-90';
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, this.props.season.title, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        id: "season-caret-".concat(this.props.season.id),
        className: "season-title-caret fas fa-caret-down ".concat(rotateCaret)
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "episodes-".concat(this.props.season.id),
        className: "episode-list-wrapper ".concat(hideEpisodes)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_episode_list__WEBPACK_IMPORTED_MODULE_1__["default"], {
        animeSlug: this.props.animeSlug,
        episodes: episodes
      }))));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (SeasonItem);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_navbar_navbar_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/navbar/navbar_container */ "./frontend/components/navbar/navbar_container.js");
...
/* harmony import */ var _components_session_signup_form_container__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/session/signup_form_container */ "./frontend/components/session/signup_form_container.js");
/* harmony import */ var _anime_anime_index_container__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./anime/anime_index_container */ "./frontend/components/anime/anime_index_container.js");
/* harmony import */ var _anime_anime_index2__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./anime/anime_index2 */ "./frontend/components/anime/anime_index2.jsx");
/* harmony import */ var _anime_anime_page_container__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./anime/anime_page_container */ "./frontend/components/anime/anime_page_container.js");
/* harmony import */ var _episodes_episode_page_container__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./episodes/episode_page_container */ "./frontend/components/episodes/episode_page_container.js");
/* harmony import */ var _queue_queue_container__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./queue/queue_container */ "./frontend/components/queue/queue_container.js");
/* harmony import */ var _landing_landing_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./landing/landing_page */ "./frontend/components/landing/landing_page.jsx");
...
var App = function App() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "row app"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_navbar_navbar_container__WEBPACK_IMPORTED_MODULE_1__["default"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Switch"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["ProtectedRoute"], {
    path: "/anime/:animeSlug/:episodeSlug",
    component: _episodes_episode_page_container__WEBPACK_IMPORTED_MODULE_9__["default"]
    ...
    path: '/anime/:slug',
    component: _anime_anime_page_container__WEBPACK_IMPORTED_MODULE_8__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["ProtectedRoute"], {
    path: "/queue",
    component: _queue_queue_container__WEBPACK_IMPORTED_MODULE_10__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["AuthRoute"], {
    path: "/login",
    component: _landing_landing_page__WEBPACK_IMPORTED_MODULE_11__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["AuthRoute"], {
    path: "/signup",
    component: _landing_landing_page__WEBPACK_IMPORTED_MODULE_11__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["ProtectedRoute"], {
    path: "/anime",
    component: _anime_anime_index2__WEBPACK_IMPORTED_MODULE_7__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_utils_route_utils__WEBPACK_IMPORTED_MODULE_2__["AuthRoute"], {
    path: "/",
    component: _landing_landing_page__WEBPACK_IMPORTED_MODULE_11__["default"]
  })));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _episode_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./episode_item */ "./frontend/components/episodes/episode_item.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Carousel = /*#__PURE__*/function (_React$Component) {
  ...
  function Carousel(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Carousel).call(this, props));
  }
...
/***/ "./frontend/components/episodes/episode_item.jsx":
/*!*******************************************************!*\
  !*** ./frontend/components/episodes/episode_item.jsx ***!
  \*******************************************************/
/*! exports provided: default */
...
/***/ "./frontend/components/episodes/episode_page.jsx":
/*!*******************************************************!*\
  !*** ./frontend/components/episodes/episode_page.jsx ***!
  \*******************************************************/
/*! exports provided: default */
...
var EpisodePage = /*#__PURE__*/function (_React$Component) {
  ...
  function EpisodePage() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(EpisodePage).apply(this, arguments));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (EpisodePage);

/***/ }),

/***/ "./frontend/components/episodes/episode_page_container.js":
/*!****************************************************************!*\
  !*** ./frontend/components/episodes/episode_page_container.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/esm/react-router-dom.js");
/* harmony import */ var _episode_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./episode_page */ "./frontend/components/episodes/episode_page.jsx");
/* harmony import */ var _reducers_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../reducers/selectors */ "./frontend/reducers/selectors.js");
/* harmony import */ var _actions_anime_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../actions/anime_actions */ "./frontend/actions/anime_actions.js");
...
var mstp = function mstp(state, ownProps) {
  return {
    episode: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_3__["findEpisode"])(state, ownProps.match.params.episodeSlug),
    anime: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_3__["findAnime"])(state, ownProps.match.params.animeSlug),
    episodes: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_3__["findEpisodesFromAnimeSlug"])(state, ownProps.match.params.animeSlug)
  };
};
...
var mdtp = function mdtp(dispatch) {
  return {
    fetchAnime: function fetchAnime(slug) {
      return dispatch(Object(_actions_anime_actions__WEBPACK_IMPORTED_MODULE_4__["fetchAnime"])(slug));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["withRouter"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mstp, mdtp)(_episode_page__WEBPACK_IMPORTED_MODULE_2__["default"])));

/***/ }),

/***/ "./frontend/components/episodes/video.jsx":
/*!************************************************!*\
  !*** ./frontend/components/episodes/video.jsx ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./frontend/components/errors/errors.jsx":
/*!***********************************************!*\
  !*** ./frontend/components/errors/errors.jsx ***!
  \***********************************************/
/*! exports provided: default */
...
var Errors = function Errors(props) {
  var errorsClass = props.errors.length === 1 ? 'error-item-mid' : 'error-item-left';
  var errors = props.errors.map(function (err, i) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: errors.length === 1 ? 'errors-wrapper-single-item' : 'errors-wrapper-multi-item'
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
...
/***/ "./frontend/components/errors/session_errors_container.js":
/*!****************************************************************!*\
  !*** ./frontend/components/errors/session_errors_container.js ***!
  \****************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors */ "./frontend/components/errors/errors.jsx");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mstp, null)(_errors__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
/* harmony import */ var _session_login_form_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../session/login_form_container */ "./frontend/components/session/login_form_container.js");
...
var LandingPage = /*#__PURE__*/function (_React$Component) {
  ...
  function LandingPage(props) {
    ...
    _this.swapForms = _this.swapForms.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(LandingPage, [{
    key: "swapForms",
    value: function swapForms(formType) {
      this.setState({
        formType: formType
      });
    }
    ...
    value: function render() {
      ...
      }, "uwuwoll!", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "mini-white-logo-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
        className: "white-logo-mini",
        src: window.whiteLogo,
        alt: ""
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "landing-tagline"
      }, "the number one streaming service for anime"), this.renderForm()));
    }
  }]);
  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("nav", {
        ...
        className: "fa-orange fas fa-tv"
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "nav-text"
      }, "anime")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        className: "nav-li",
        key: "queue"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Link"], {
        to: "/queue"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        className: "fa-orange far fa-bookmark"
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "nav-text"
        ...
        className: "fa-orange fas fa-user-alt"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "nav-text"
      }, "logout")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        className: "nav-li search-bar-container"
...
/***/ "./frontend/components/queue/queue_container.js":
/*!******************************************************!*\
  !*** ./frontend/components/queue/queue_container.js ***!
  \******************************************************/
/*! exports provided: default */
...
var Root = function Root(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__["Provider"], {
    store: store
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["BrowserRouter"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_app__WEBPACK_IMPORTED_MODULE_3__["default"], null)));
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["withRouter"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mstp, mdtp)(_session_form__WEBPACK_IMPORTED_MODULE_3__["default"])));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _errors_session_errors_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../errors/session_errors_container */ "./frontend/components/errors/session_errors_container.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/esm/react-router-dom.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var SessionForm = /*#__PURE__*/function (_React$Component) {
  ...
  function SessionForm(props) {
    ...
    _this.handleSubmit = _this.handleSubmit.bind(_assertThisInitialized(_this));
    _this.swapForms = _this.swapForms.bind(_assertThisInitialized(_this));
    _this.toggleErrors = _this.toggleErrors.bind(_assertThisInitialized(_this));
    _this.loginAsGuest = _this.loginAsGuest.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(SessionForm, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var user;
      if (this.props.formType === 'sign up!') user = {
      ...
      var that = this;
      this.props.action(user).fail(function () {
    ...
    key: "toggleErrors",
    value: function toggleErrors() {
      this.setState({
        renderErrors: !this.state.renderErrors
      });
    }
  }, {
    key: "emailField",
    value: function emailField() {
      if (this.props.formType === "sign up!") {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          className: "floating-email-label"
        }, "email"));
      }
    ...
    value: function renderFormTitle() {
      if (this.props.formType === 'sign up!') return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }), this.state.renderErrors ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_errors_session_errors_container__WEBPACK_IMPORTED_MODULE_1__["default"], {
        toggleErrors: this.toggleErrors
      }) : null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        className: "form",
        onSubmit: this.handleSubmit
      }, this.renderFormTitle(), this.emailField(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "input-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
        placeholder: " ",
        ...
        className: this.props.formType === 'sign up!' ? 'floating-label' : 'dual-floating-label'
      }, this.props.formType === 'sign up!' ? 'username' : 'email or username')), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "input-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "password",
        placeholder: " ",
        ...
        className: "input-container form-btn-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        className: "form-btn"
      }, this.props.formType), this.renderDemoLogin()), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.currentUser) {
    ...
    var bootstrap = document.querySelector('script#bootstrap-script');
  ...
  window.fetchList = _actions_lists_actions__WEBPACK_IMPORTED_MODULE_4__["fetchList"];
...
/* harmony import */ var _entity_reducers_users_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./entity_reducers/users_reducer */ "./frontend/reducers/entity_reducers/users_reducer.js");
/* harmony import */ var _entity_reducers_anime_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./entity_reducers/anime_reducer */ "./frontend/reducers/entity_reducers/anime_reducer.js");
/* harmony import */ var _entity_reducers_seasons_reducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entity_reducers/seasons_reducer */ "./frontend/reducers/entity_reducers/seasons_reducer.js");
...
var entitiesReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  users: _entity_reducers_users_reducer__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/***/ "./frontend/reducers/entity_reducers/anime_reducer.js":
/*!************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/anime_reducer.js ***!
  \************************************************************/
/*! exports provided: default */
...
var animeReducer = function animeReducer() {
  ...
  switch (action.type) {
    ...
    case _actions_anime_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_ANIME"]:
      return Object.assign({}, state, _defineProperty({}, action.payload.anime.id, action.payload.anime));
...
/***/ "./frontend/reducers/entity_reducers/episodes_reducer.js":
/*!***************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/episodes_reducer.js ***!
  \***************************************************************/
/*! exports provided: default */
...
var episodesReducer = function episodesReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state);
  var newState = Object.assign({}, state);
  ...
  switch (action.type) {
    case _actions_anime_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_ALL_ANIME"]:
      Object.values(action.payload.episodes).forEach(function (episode) {
...
/* harmony default export */ __webpack_exports__["default"] = (episodesReducer);

/***/ }),

/***/ "./frontend/reducers/entity_reducers/lists_reducer.js":
/*!************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/lists_reducer.js ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./frontend/reducers/entity_reducers/saved_anime_reducer.js":
/*!******************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/saved_anime_reducer.js ***!
  \******************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (savedAnimeReducer);

/***/ }),

/***/ "./frontend/reducers/entity_reducers/seasons_reducer.js":
/*!**************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/seasons_reducer.js ***!
  \**************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (seasonsReducer);

/***/ }),

/***/ "./frontend/reducers/entity_reducers/users_reducer.js":
/*!************************************************************!*\
  !*** ./frontend/reducers/entity_reducers/users_reducer.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _slugs_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./slugs_reducer */ "./frontend/reducers/slugs_reducer.js");
...
var rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  ...
  slugs: _slugs_reducer__WEBPACK_IMPORTED_MODULE_4__["default"]
});
...
var findAnime = function findAnime(state, slug) {
...
var findSeasonsFromAnimeSlug = function findSeasonsFromAnimeSlug(state, slug) {
  ...
  if (!anime) return [];
  return anime.seasonIds.map(function (id) {
    return state.entities.seasons[id];
  });
};
var findEpisodesFromAnimeSlug = function findEpisodesFromAnimeSlug(state, slug) {
  var anime = findAnime(state, slug);
  if (!anime) return [];
...
var findSavedAnime = function findSavedAnime(state) {
  var list = findList(state);
  var savedAnime = Object.values(state.entities.savedAnime).filter(function (anime) {
    return anime.listId === list.id;
  });
...
var findList = function findList(state) {
  return Object.values(state.entities.lists).filter(function (list) {
    return list.userId === findCurrentUser(state).id;
  })[0];
};
...
/***/ "./frontend/reducers/slugs_reducer.js":
/*!********************************************!*\
  !*** ./frontend/reducers/slugs_reducer.js ***!
  \********************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
/* harmony import */ var _slugs_reducers_anime_slugs_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slugs_reducers/anime_slugs_reducer */ "./frontend/reducers/slugs_reducers/anime_slugs_reducer.js");
/* harmony import */ var _slugs_reducers_episode_slugs_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slugs_reducers/episode_slugs_reducer */ "./frontend/reducers/slugs_reducers/episode_slugs_reducer.js");



var slugsReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  anime: _slugs_reducers_anime_slugs_reducer__WEBPACK_IMPORTED_MODULE_1__["default"],
  episodes: _slugs_reducers_episode_slugs_reducer__WEBPACK_IMPORTED_MODULE_2__["default"]
});
/* harmony default export */ __webpack_exports__["default"] = (slugsReducer);

/***/ }),

/***/ "./frontend/reducers/slugs_reducers/anime_slugs_reducer.js":
/*!*****************************************************************!*\
  !*** ./frontend/reducers/slugs_reducers/anime_slugs_reducer.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
var animeSlugsReducer = function animeSlugsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state);
  var newState = Object.assign({}, state);
...
/* harmony default export */ __webpack_exports__["default"] = (animeSlugsReducer);

/***/ }),

/***/ "./frontend/reducers/slugs_reducers/episode_slugs_reducer.js":
/*!*******************************************************************!*\
  !*** ./frontend/reducers/slugs_reducers/episode_slugs_reducer.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var episodeSlugsReducer = function episodeSlugsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state);
  var newState = Object.assign({}, state);
...
/* harmony default export */ __webpack_exports__["default"] = (episodeSlugsReducer);
...
/***/ "./frontend/utils/anime_api_utils.js":
/*!*******************************************!*\
  !*** ./frontend/utils/anime_api_utils.js ***!
  \*******************************************/
/*! exports provided: fetchAllAnime, fetchAnime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./frontend/utils/episodes_api_util.js":
/*!*********************************************!*\
  !*** ./frontend/utils/episodes_api_util.js ***!
  \*********************************************/
/*! exports provided: fetchEpisode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var fetchEpisode = function fetchEpisode(episodeId) {
  return $.ajax({
    method: 'GET',
    url: "/api/episodes/".concat(episodeId)
  });
};

/***/ }),

/***/ "./frontend/utils/lists_api_utils.js":
/*!*******************************************!*\
  !*** ./frontend/utils/lists_api_utils.js ***!
  \*******************************************/
